Pod::Spec.new do |s|
  ...
  s.dependency 'sf-wkb-ios', '~> 3.0.1'
  s.dependency 'sf-wkt-ios', '~> 1.0.1'
  s.dependency 'sf-proj-ios', '~> 3.0.1'
  s.dependency 'ogc-api-features-json-ios', '~> 2.0.1'
  s.dependency 'tiff-ios', '~> 2.0.1'
end
