...
NSString * const DC_TABLE_NAME = @"gpkg_data_columns";
NSString * const DC_COLUMN_PK1 = @"table_name";
NSString * const DC_COLUMN_PK2 = @"column_name";
NSString * const DC_COLUMN_TABLE_NAME = @"table_name";
NSString * const DC_COLUMN_COLUMN_NAME = @"column_name";
NSString * const DC_COLUMN_NAME = @"name";
NSString * const DC_COLUMN_TITLE = @"title";
NSString * const DC_COLUMN_DESCRIPTION = @"description";
NSString * const DC_COLUMN_MIME_TYPE = @"mime_type";
NSString * const DC_COLUMN_CONSTRAINT_NAME = @"constraint_name";
...
-(void) setContents: (GPKGContents *) contents{
    if(contents != nil){
        ...
        if(dataType != TILES && dataType != FEATURES){
