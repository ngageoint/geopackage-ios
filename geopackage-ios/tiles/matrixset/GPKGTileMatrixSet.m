...
-(void) setContents: (GPKGContents *) contents{
    if(contents != nil){
        ...
        if(dataType != GPKG_CDT_TILES && dataType != GPKG_CDT_GRIDDED_COVERAGE){
            [NSException raise:@"Contents Type" format:@"The Contents of a Tile Matrix Set must have a data type of %@ or %@", [GPKGContentsDataTypes name:GPKG_CDT_TILES], [GPKGContentsDataTypes name:GPKG_CDT_GRIDDED_COVERAGE]];
        }
