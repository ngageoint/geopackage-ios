...
- (void)testElevationsNearestNeighbor {
    [GPKGElevationTilesTiffTestUtils testElevationsWithGeoPackage:self.geoPackage andValues:nil andAlgorithm:GPKG_ETA_NEAREST_NEIGHBOR andAllowNils:allowNulls];
}
...
- (void)testElevationsBilinear {
    [GPKGElevationTilesTiffTestUtils testElevationsWithGeoPackage:self.geoPackage andValues:nil andAlgorithm:GPKG_ETA_BILINEAR andAllowNils:allowNulls];
}
...
- (void)testElevationsBicubic {
    [GPKGElevationTilesTiffTestUtils testElevationsWithGeoPackage:self.geoPackage andValues:nil andAlgorithm:GPKG_ETA_BICUBIC andAllowNils:allowNulls];
}
...
-(void) testBounds{
    ...
    for(int i = GPKG_ETA_NEAREST_NEIGHBOR; i <= GPKG_ETA_BICUBIC; i++){
        ...
        for (double lat = maxLatitude - (heightPixelDistance * .5); lat >= minLatitude; lat -= heightPixelDistance) {
            [log appendString:@"\n"];
            for (double lon = minLongitude + (widthPixelDistance * .5); lon <= maxLongitude; lon += widthPixelDistance) {
                NSDecimalNumber * elevation = [GPKGElevationTilesTiffTestUtils elevationWithGeoPackage:self.geoPackage andAlgorithm:algorithm andLatitude:lat andLongitude:lon andEpsg:requestEpsg];
        ...
        GPKGCoverageDataResults * results = [GPKGElevationTilesTiffTestUtils elevationsWithGeoPackage:self.geoPackage andAlgorithm:algorithm andBoundingBox:boundingBox andWidth:width andHeight:height andEpsg:requestEpsg];
        if(!allowNulls){
...
-(void) testFullBoundingBox{
    ...
    for(NSString * elevationTable in coverageDataTables){
        ...
        for(int i = GPKG_ETA_NEAREST_NEIGHBOR; i <= GPKG_ETA_BICUBIC; i++){
            ...
            NSDecimalNumber * value = [GPKGElevationTilesTiffTestUtils elevationWithGeoPackage:self.geoPackage andAlgorithm:algorithm andLatitude:minLatitude andLongitude:maxLongitude andEpsg:geoPackageEpsg];
            [log appendFormat:@"   %@", value];
            if(algorithm == GPKG_ETA_NEAREST_NEIGHBOR){
                if (!allowNulls) {
                    [GPKGTestUtils assertNotNil:value];
            ...
            GPKGCoverageDataResults * results = [GPKGElevationTilesTiffTestUtils elevationsWithGeoPackage:self.geoPackage andAlgorithm:algorithm andBoundingBox:boundingBox andWidth:width andHeight:height andEpsg:geoPackageEpsg];
            [log appendFormat:@"\n\n%@ Full Bounding Box\n", [GPKGCoverageDataAlgorithms name:algorithm]];
            NSArray * values = [results values];
            ...
            for (int row = 0; row < [tileMatrix.matrixHeight intValue]; row++) {
                for (int column = 0; column < [tileMatrix.matrixWidth intValue]; column++) {
                    ...
                    value = [GPKGElevationTilesTiffTestUtils elevationWithGeoPackage:self.geoPackage andAlgorithm:algorithm andLatitude:maxLatitude2 andLongitude:minLongitude2 andEpsg:geoPackageEpsg];
                    ...
                    value = [GPKGElevationTilesTiffTestUtils elevationWithGeoPackage:self.geoPackage andAlgorithm:algorithm andLatitude:maxLatitude2 andLongitude:maxLongitude2 andEpsg:geoPackageEpsg];
                    ...
                    value = [GPKGElevationTilesTiffTestUtils elevationWithGeoPackage:self.geoPackage andAlgorithm:algorithm andLatitude:minLatitude2 andLongitude:minLongitude2 andEpsg:geoPackageEpsg];
                    ...
                    value = [GPKGElevationTilesTiffTestUtils elevationWithGeoPackage:self.geoPackage andAlgorithm:algorithm andLatitude:minLatitude2 andLongitude:maxLongitude2 andEpsg:geoPackageEpsg];
...
-(void) testLocationWithLatitude: (double) latitude andLongitude: (double) longitude{
    ...
    for(int i = GPKG_ETA_NEAREST_NEIGHBOR; i <= GPKG_ETA_BICUBIC; i++){
        ...
        [log appendFormat:@"%@: %@\n", [GPKGCoverageDataAlgorithms name:algorithm], elevation];
    }
    [log appendString:@"\n"];
