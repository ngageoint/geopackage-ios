...
+(void) testElevationsWithGeoPackage: (GPKGGeoPackage *) geoPackage andValues: (GPKGElevationTileValues *) elevationTileValues andAlgorithm: (enum GPKGElevationTilesAlgorithm) algorithm andAllowNils: (BOOL) allowNils{
    ...
    NSArray * elevationTables = [GPKGElevationTilesTiff tablesForGeoPackage:geoPackage];
 ...
 * @param allowNils
 */
+(void) testTileRowWithGeoPackage: (GPKGGeoPackage *) geoPackage andValues: (GPKGElevationTileValues *) elevationTileValues andElevationTiles: (GPKGElevationTilesTiff *) elevationTiles andTileMatrixSet: (GPKGTileMatrixSet *) tileMatrixSet andGriddedTile: (GPKGGriddedTile *) griddedTile andTileRow: (GPKGTileRow *) tileRow andAlgorithm: (enum GPKGElevationTilesAlgorithm) algorithm andAllowNils: (BOOL) allowNils{
 ...
 * @param allowNils
 */
+(void) testElevationQueriesWithGeoPackage: (GPKGGeoPackage *) geoPackage andElevationTiles: (GPKGElevationTilesTiff *) elevationTiles andTileMatrixSet: (GPKGTileMatrixSet *) tileMatrixSet andAlgorithm: (enum GPKGElevationTilesAlgorithm) algorithm andAllowNils: (BOOL) allowNils{
    ...
    GPKGElevationTilesTiff * elevationTiles2 = [[GPKGElevationTilesTiff alloc] initWithGeoPackage:geoPackage andTileDao:[elevationTiles tileDao] andProjection:requestProjection];
...
+(NSDecimalNumber *) elevationWithGeoPackage: (GPKGGeoPackage *) geoPackage andAlgorithm: (enum GPKGElevationTilesAlgorithm) algorithm andLatitude: (double) latitude andLongitude: (double) longitude andEpsg: (int) epsg{
    ...
    for(NSString * elevationTable in elevationTables){
        ...
        // Test getting the elevation of a single coordinate
        GPKGElevationTilesTiff * elevationTiles = [[GPKGElevationTilesTiff alloc] initWithGeoPackage:geoPackage andTileDao:tileDao andProjection:requestProjection];
        [elevationTiles setAlgorithm:algorithm];
